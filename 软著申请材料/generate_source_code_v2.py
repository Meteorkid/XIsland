...
def add_code_lines(doc, code_lines, start_line_num):
    """添加代码行，每页正好50行"""
    line_count = 0
...
def create_source_code_document():
    ...
    # 添加前30页代码
    print("添加前30页代码...")
    next_line_num = add_code_lines(doc, front_lines, 1)
    ...
    if back_lines:
        ...
        # 添加后30页代码
        print("添加后30页代码...")
        add_code_lines(doc, back_lines, next_line_num)
    ...
    print(f"✅ 每页50行代码：已设置")
    print(f"✅ 无空行：已过滤")
    print(f"✅ 总共60页：前30页 + 后30页")
    print(f"✅ 字体：{CODE_FONT_NAME}，{CODE_FONT_SIZE.pt}pt")
